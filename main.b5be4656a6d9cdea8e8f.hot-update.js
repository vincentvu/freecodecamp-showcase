  ...
  _createClass(App, [{
    ...
    value: function updateNumber(e) {
      ...
      switch (value) {
        ...
        case "=":
          result = eval(this.state.expression + this.state.operator + this.state.number);
          this.setState(function () {
        ...
        default:
          ...
          } else if (e.target.value == "." && this.state.expression.includes(".")) {} else if (this.state.expression === "0") {
            this.setState({
...
//# sourceMappingURL=main.b5be4656a6d9cdea8e8f.hot-update.js.map