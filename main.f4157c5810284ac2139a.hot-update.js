    ...
    value: function updateNumber(e) {
      ...
      switch (value) {
        ...
        default:
          ...
          } else if (e.target.value == "." && this.state.number.includes(".")) {} else if (!this.state.number || this.state.number === "0") {
            this.setState({
...
//# sourceMappingURL=main.f4157c5810284ac2139a.hot-update.js.map