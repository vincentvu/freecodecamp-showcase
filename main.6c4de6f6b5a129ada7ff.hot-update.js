    ...
    value: function updateNumber(e) {
      ...
      switch (value) {
        ...
        default:
          ...
          } else if (e.target.value == "." && this.state.number.includes(".")) {} else if ((!this.state.number || this.state.number === "0") && !value.includes(".")) {
            this.setState({
...
//# sourceMappingURL=main.6c4de6f6b5a129ada7ff.hot-update.js.map